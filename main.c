...
int main() {
    ...
    while (1) {
        ...
        if (syntax_error) {
            ...
            if (fgets(exit_control, sizeof(exit_control), stdin) != NULL) {
                exit_control[strcspn(exit_control, "\r\n")] = 0;
                if (strcmp(exit_control, "exit") == 0) {
                    break;
                }
            }
            continue;
        ...
        printf("\nType 'exit' to quit or press Enter to run another program...");
        fflush(stdout);
